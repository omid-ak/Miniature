"""
this is a assembler known as Miniature.
...
#################### R Type Instructions ############################
    if 'add' in l:
        ...
        pc += 1
        line_counter += 1
        if argsls_1[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_1[0] != "-":
            Label_list[argsls_1[0]] = line_counter
    elif 'slt' in l:
        opcode_2 = '0010'
        ...
        pc += 1
        line_counter += 1
        if argsls_2[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_2[0] != "-":
            Label_list[argsls_2[0]] = line_counter
    elif 'or' in l:
        opcode_3 = '0011'
        ...
        pc += 1
        line_counter += 1
        if argsls_3[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_3[0] != "-":
            Label_list[argsls_3[0]] = line_counter
    elif 'nand' in l:
        opcode_4 = '0100'
        ...
        pc += 1
        line_counter += 1
        if argsls_4[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_4[0] != "-":
            Label_list[argsls_4[0]] = line_counter
####################### I Type Instructions ############################
    elif 'addi' in l:
        opcode_5 = '0101'
        ...
        pc += 1
        line_counter += 1
        if argsls_5[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_5[0] != "-":
            Label_list[argsls_5[0]] = line_counter
    elif 'slti' in l:
        opcode_6 = '0110'
        ...
        pc += 1
        line_counter += 1
        if argsls_6[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_6[0] != "-":
            Label_list[argsls_6[0]] = line_counter
    elif 'ori' in l:
        opcode_7 = '0111'
        ...
        pc += 1
        line_counter += 1
        if argsls_7[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_7[0] != "-":
            Label_list[argsls_7[0]] = line_counter
    elif 'lui' in l:
        opcode_8 = '1000'
        ...
        pc += 1
        line_counter += 1
        if argsls_8[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_8[0] != "-":
            Label_list[argsls_8[0]] = line_counter
    elif 'lw' in l:
        opcode_9 = '1001'
        ...
        pc += 1
        line_counter += 1
        if argsls_9[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_9[0] != "-":
            Label_list[argsls_9[0]] = line_counter
    elif 'sw' in l:
        opcode_10 = '1010'
        ...
        pc += 1
        line_counter += 1
        if argsls_10[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_10[0] != "-":
            Label_list[argsls_10[0]] = line_counter
    elif 'beq' in l:
        opcode_11 = '1011'
        ...
        pc += 1
        line_counter += 1
        if argsls_11[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_11[0] != "-":
            Label_list[argsls_11[0]] = line_counter
    elif 'jalr' in l:
        opcode_12 = '1100'
        ...
        pc += 1
        line_counter += 1
        if argsls_12[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_12[0] != "-":
            Label_list[argsls_12[0]] = line_counter
############### J Type Instructions ##############################
    elif 'j' in l:
        opcode_13 = '1101'
        ...
        pc += 1
        line_counter += 1
        if argsls_13[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_13[0] != "-":
            Label_list[argsls_13[0]] = line_counter
    elif 'halt' in l:
        opcode_14 = '1110'
        A = ''
...
############### Directive Instructions ############################
        ...
        pc += 1
        line_counter += 1
        if argsls_15[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_15[0] != "-":
            Label_list[argsls_15[0]] = line_counter
    elif '.space' in  l:
        ...
        pc += 1
        line_counter += 1
        if argsls_16[0] in Label_list.keys():
            print("an error occurred on line %d" % line_counter)
            print("Duplicate Label Error")
            exit(1)
        if argsls_16[0] != "-":
            Label_list[argsls_16[0]] = line_counter
############## Denied Instructions #################################
    else:
        line_counter += 1
